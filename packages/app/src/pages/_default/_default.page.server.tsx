...
import type {ViteRenderContext} from "../../../../engine-vite/src/interfaces/ViteRenderContext";
...
function render({ Page, contextProps}: {Page: ReactComponent; contextProps: ViteRenderContext}) {
